...
![Liste des filtres d’un visuel](media/power-bi-report-filter-preview/power-bi-filter-visual.png)
...
1. Par défaut, les consommateurs de votre rapport peuvent voir le volet Filtres. Si vous ne souhaitez pas que ces consommateurs voient le volet, sélectionnez l’icône représentant un œil en regard de **Filtres**.
    ...
    ![Icône représentant un œil du filtre Power BI](media/power-bi-report-filter-preview/power-bi-filter-eye.png)
...
Lorsque vous ajoutez un visuel à un canevas de rapport, Power BI ajoute automatiquement un filtre au volet Filtres pour chaque champ dans le visuel. 
...
Lorsque vous activez et désactivez ces paramètres dans le nouveau volet Filtres, les modifications sont répercutées dans le rapport. Les filtres masqués ne s’affichent pas dans la fenêtre contextuelle de filtre pour un visuel.
...
![Réorganiser l’ordre de tri des filtres](media/power-bi-report-filter-preview/power-bi-filter-sort.gif)
...
## <a name="filters-pane-scaling"></a>Mise à l’échelle du volet Filtres

Le nouveau volet Filtres s’adapte à la page du rapport et aux visuels. Ainsi, la page du rapport et le volet Filtres restent proportionnels l'un à l'autre.
...
Dans la section Expérience de filtrage des paramètres du rapport, vous avez la possibilité de contrôler si les utilisateurs peuvent modifier le type de filtre.

![Limiter les changements de type de filtre](media/power-bi-report-filter-preview/power-bi-filter-restrict-change.png)
