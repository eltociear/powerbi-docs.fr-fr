...
1. Basculez dans la [vue Données](../connect-data/desktop-data-view.md) en sélectionnant l’icône de table ![icône de table](media/sample-tutorial-connect-to-the-samples/power-bi-data-icon.png).
...
1. Basculez vers la [vue Relation](../transform-model/desktop-relationship-view.md) en sélectionnant l’icône suivante : ![icône de la vue Relation](media/sample-tutorial-connect-to-the-samples/power-bi-desktop-relationship-icon.png).
