...
1. Sélectionnez le nom du rapport pour ouvrir celui-ci en mode Lecture.  
   
    ![](media/service-report-open/power-bi-reading-view.png)
1. Le [mode Lecture vous permet de faire de nombreuses choses](service-reading-view-and-editing-view.md).  Comme cet exemple de rapport comprend plusieurs pages, commencez par les explorer en sélectionnant chaque onglet en bas du canevas de rapport. 
