...
Pour trier un graphique, sélectionnez les points de suspension (...) en haut à droite du graphique, sélectionnez **Tri** et choisissez le champ que vous souhaitez trier et le sens du tri. Pour plus d’informations, consultez [Modifier l’ordre de tri d’un visuel](../consumer/end-user-change-sort.md).
