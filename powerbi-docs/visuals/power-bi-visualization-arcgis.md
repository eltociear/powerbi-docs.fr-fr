...
Découvrez quelles données sont transférées vers Esri en consultant leur [documentation](https://doc.arcgis.com/en/maps-for-powerbi/get-started/data-transfer.htm) respective.
