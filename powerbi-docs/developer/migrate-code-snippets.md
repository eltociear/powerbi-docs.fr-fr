...
---
# <a name="code-snippets-for-migrating-content-from-power-bi-embedded"></a>Extraits de code pour migrer du contenu à partir de Power BI Embedded
Voici quelques extraits de code pour les opérations de base nécessaires à la migration de contenu. Pour les flux liés à certains types de rapports, consultez la page [Comment migrer le contenu d’une collection d’espaces de travail Power BI Embedded vers Power BI](migrate-from-powerbi-embedded.md#content-migration).
