---
title: Incorporer du contenu Power BI dans une application pour vos clients (US Government)
...
---
# <a name="embed-a-power-bi-dashboard-tile-or-report-into-your-application-for-us-government"></a>Incorporer un tableau de bord, une vignette ou un rapport Power BI dans votre application pour US Government
...
À la différence du cloud public, le cloud US Government a trois catégories différentes.
...
Pour vous familiariser avec cette procédure pas à pas, vous avez besoin d’un compte **Power BI US Government**. Si vous n’avez pas de compte configuré, vous pouvez [vous inscrire à un compte Power BI US Government](../service-govus-signup.md).
...
Vous devez inscrire votre application à Azure AD pour effectuer des appels d’API REST. Pour plus d’informations, consultez [Inscrire une application Azure AD pour incorporer du contenu Power BI](register-app.md). Comme il existe trois catégories différentes selon le type d’administration auquel vous appartenez, il existe trois URL distinctes pour inscrire votre application.
...
Dans votre application, vous devez d’abord obtenir un **jeton d’accès**, à partir d’Azure AD, avant de pouvoir effectuer des appels d’API REST Power BI. Pour plus d’informations, consultez [Authentifier des utilisateurs et obtenir un jeton d’accès Azure AD pour votre application Power BI](get-azuread-access-token.md). Comme il existe trois catégories différentes selon le type d’administration auquel vous appartenez, il existe deux URL distinctes pour obtenir un jeton d’accès pour votre application.
