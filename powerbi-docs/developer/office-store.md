...
Une fois que vous avez créé votre visuel Power BI, vous pouvez le publier sur AppSource pour que les utilisateurs puissent le trouver et l’utiliser. Pour plus d'informations sur la création d'un visuel Power BI, voir [Développement d'un visuel Power BI](visuals/custom-visual-develop-tutorial.md).
