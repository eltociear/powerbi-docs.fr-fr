...
Les éléments de la liste sont également associés à une couleur et un nombre au format (#/#). Ils indiquent le nombre de rapports pouvant être téléchargés. La couleur noir signifie que tous les rapports peuvent être téléchargés.
