...
Pour plus d’informations sur les visuels Power BI, consultez [Questions fréquentes sur les visuels Power BI avec achats supplémentaires](https://docs.microsoft.com/power-bi/power-bi-custom-visuals-faq#visuals-with-additional-purchases).
