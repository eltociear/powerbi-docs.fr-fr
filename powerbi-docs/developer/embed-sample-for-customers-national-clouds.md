---
title: Analytique incorporée permettant d’incorporer du contenu Power BI dans une application pour les clouds nationaux et du secteur public
...
* Government Community Cloud (GCC) :
    ...
    > [!Note]
    > Les comptes GCC prennent uniquement en charge les capacités P et EM.
...
Un exemple d’application est disponible dans l’[exemple Incorporation pour votre organisation](https://github.com/Microsoft/PowerBI-Developer-Samples/tree/master/App%20Owns%20Data).
