...
| Lire et écrire tous les tableaux de bord | L’application peut afficher et modifier tous les tableaux de bord pour l’utilisateur connecté et ceux auxquels il a accès. | Dashboard.ReadWrite.All |
...
| Afficher tout le contenu dans un locataire |Si l’utilisateur connecté est un administrateur service Power BI, l’application peut afficher et écrire dans tous les artefacts &mdash;y compris les groupes, les rapports, les tableaux de bord et les jeux de données&mdash; dans Power BI. |Tenant.Read.All |
| Lire et écrire tous les espaces de travail | L’application peut afficher et modifier tous les espaces de travail auxquels l’utilisateur connecté a accès. | Workspace.ReadWrite.All |
