...
description: 'Vue d’ensemble de Power BI et de la façon dont les différents composants s’ajustent : Power BI Desktop, Service Power BI, Power BI mobile, Report Server.'
author: mihart
manager: kfile
ms.service: powerbi
...
[Se connecter à un service](/power-bi/service-tutorial-connect-to-github.md)
