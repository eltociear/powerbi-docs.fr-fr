...
Cochez cette case en cas d’implémentation d’une [sécurité dynamique au niveau des lignes](/analysis-services/tutorial-tabular-1200/supplemental-lesson-implement-dynamic-security-by-using-row-filters) basée sur le nom d’utilisateur ou l’ID de connexion. 
