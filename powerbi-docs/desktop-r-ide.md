...
### <a name="enabling-an-external-r-ide"></a>Activation d’un IDE R externe
...
### <a name="launching-an-r-ide-from-power-bi-desktop"></a>Lancement d’un IDE R à partir de Power BI Desktop
