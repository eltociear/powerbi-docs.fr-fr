...
Si vous ne souhaitez pas que l’inscription en libre-service soit accessible aux utilisateurs de votre organisation, consultez [Activation et désactivation de l’inscription en libre-service](service-admin-disable-self-service.md) pour savoir comment la désactiver.
