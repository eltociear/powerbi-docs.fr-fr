...
2. Dans la barre de menus supérieure, sélectionnez **S’abonner** ou l’icône en forme d’enveloppe ![](media/service-report-subscribe/power-bi-icon-envelope.png).
...
L’écran de gestion des abonnements est accessible de 2 façons.  La première méthode consiste à sélectionner **Gérer tous les abonnements** à partir de la boîte de dialogue **Abonnez-vous aux e-mails** (voir l’étape 3 ci-dessus). La deuxième consiste à sélectionner l’icône en forme de roue dentée Power BI ![](media/service-report-subscribe/power-bi-settings-icon.png) à partir de la barre de menus supérieure et à choisir **Paramètres**.
