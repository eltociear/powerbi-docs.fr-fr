...
Vous planifiez de créer une application ? Pour plus d’informations, consultez [Créer des espaces de travail avec vos collègues dans Power BI](service-create-distribute-apps.md).
