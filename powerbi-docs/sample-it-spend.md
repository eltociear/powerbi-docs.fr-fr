...
Ce tutoriel utilise le service Power BI et le pack de contenu de l’exemple Analyse des dépenses informatiques. Les expériences d’utilisation des rapports étant similaires, vous pouvez également poursuivre avec Power BI Desktop et l’exemple de fichier .pbix.
