...
2. Dans la barre de navigation supérieure, vous voyez soit l’option **Définir comme tableau de bord par défaut**, soit simplement l’icône Par défaut ![](media/service-dashboard-featured/power-bi-featured-icon.png). Sélectionnez l’une des deux.
