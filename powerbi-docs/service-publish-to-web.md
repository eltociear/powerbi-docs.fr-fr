...
> 
> [!IMPORTANT]
> Les administrateurs Power BI peuvent empêcher les utilisateurs d’utiliser la publication sur le web à partir du portail d’administration. Dans **Paramètres du client**, définissez **Publier sur le web** sur **Désactivé**. Il s’agit d’un paramètre à l’échelle du locataire. Pour plus d’informations, consultez [Portail d’administration Power BI](service-admin-portal.md).
> 
> 
