...
Lorsque vous activez Questions et réponses pour vos données locales, une partie des données est mise en cache dans le service. Le but est d’assurer le fonctionnement de Questions et réponses avec des performances raisonnables. Power BI exclut les valeurs dépassant 24 caractères de la mise en cache. Le cache est supprimé après quelques heures une fois Questions et réponses désactivé en décochant la case**Activer Questions et réponses pour ce jeu de données**, ou lorsque vous supprimez votre jeu de données.
