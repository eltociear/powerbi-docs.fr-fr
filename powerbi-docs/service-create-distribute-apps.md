...
Vous planifiez de créer une application ? Pour plus d’informations, consultez [Créer des espaces de travail avec vos collègues dans Power BI](service-create-workspaces.md).
...
![Page d’accueil de l’application dans le service Power BI](./media/service-create-distribute-apps/power-bi-app-landing-page-opportunity-480.png)

**Sur votre appareil mobile Android ou iOS** 

Quand vous cliquez sur le lien qui figure dans l’e-mail sur votre appareil mobile, l’application s’installe automatiquement et ouvre la liste des contenus dans l’application mobile. 

![Liste de contenu d’application sur l’appareil mobile](./media/service-create-distribute-apps/power-bi-app-index-it-spend-360.png)
...
1. Sélectionnez **Applications** ![Applications dans le volet de navigation de gauche](./media/service-create-distribute-apps/power-bi-apps-bar.png) > **Obtenir des applications**. 
   
     ![Icône Obtenir des applications](./media/service-create-distribute-apps/power-bi-service-apps-get-apps-oppty.png)
2. Dans AppSource, vous pouvez chercher sous **Mon organisation** pour affiner les résultats et trouver l’application souhaitée.
     ...
     ![Dans AppSource sous Mon organisation](./media/service-create-distribute-apps/power-bi-appsource-my-org.png)
...
Vous pouvez maintenant explorer les données dans les tableaux de bord et rapports de l’application. Vous avez accès à toutes les interactions Power BI standard, telles que le filtrage, la mise en évidence, le tri et la descente dans la hiérarchie. Vous pouvez aussi [exporter les données vers Excel ](consumer/end-user-export-data.md) à partir d’un tableau ou d’un autre visuel d’un rapport. 

![Exporter des données à partir d’un visuel Power BI](./media/service-create-distribute-apps/power-bi-service-export-data-visual.png)



## <a name="next-steps"></a>Étapes suivantes
* [Applications Power BI pour des services externes](consumer/end-user-connect-to-services.md)
