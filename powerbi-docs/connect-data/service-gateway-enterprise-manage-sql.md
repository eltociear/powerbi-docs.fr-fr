...
description: Comment gérer la passerelle de données locale et les sources de données SQL Server qui font partie de cette passerelle.
author: arthiriyer
ms.reviewer: ''
ms.service: powerbi
