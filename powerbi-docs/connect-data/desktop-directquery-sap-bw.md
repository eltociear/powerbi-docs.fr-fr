...
| Traitement des hiérarchies déséquilibrées |![Capture d’écran d’un contenu déséquilibré, montrant le traitement des hiérarchies déséquilibrées.](media/desktop-directquery-sap-bw/directquery-sap-bw_01.png) |
