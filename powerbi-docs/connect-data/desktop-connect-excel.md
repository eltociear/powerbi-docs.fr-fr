...
![Capture d’écran de l’option Excel.](media/desktop-connect-excel/connect_to_excel_1.png)

Sélectionnez votre classeur dans la boîte de dialogue **Ouvrir** qui s’affiche.
![Capture d’écran de la boîte de dialogue Ouvrir.](media/desktop-connect-excel/connect_to_excel_2.png)
...
![Capture d’écran de la fenêtre Navigateur.](media/desktop-connect-excel/connect_to_excel_3.png)
...
![Capture d’écran de la fenêtre Charger.](media/desktop-connect-excel/connect_to_excel_4.png)
...
![Capture d’écran du volet Champs.](media/desktop-connect-excel/connect_to_excel_5.png)
