...
- Créez un espace de travail dans Power BI sans créer de groupe Office 365 associé sous-jacent. Toute l’administration des espaces de travail se fait dans Power BI et non pas dans Office 365.
- Continuez à gérer l’accès des utilisateurs au contenu via les groupes Office 365, si vous le souhaitez. Il vous suffit d’ajouter un groupe Office 365 dans la liste d’accès de l’espace de travail.
...
Power BI continue à répertorier tous les groupes Office 365 dont vous êtes membre. Cela évite de modifier les flux de travail existants.
...
Oui. Étant donné que nous prenons en charge les deux types d’espaces de travail côte à côte, nous continuons à répertorier tous les groupes Office 365 auxquels vous avez accès dans la liste des espaces de travail.
