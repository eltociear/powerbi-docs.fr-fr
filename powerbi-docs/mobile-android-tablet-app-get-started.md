...
![Tableau de bord Power BI sur tablette Android](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-report.png)
...
Ensuite, dans l’application Power BI pour tablettes Android, vous pouvez interagir avec vos tableaux de bord et rapports, tant localement que dans le cloud. Découvrez les [nouveautés des applications mobiles Power BI](mobile-whats-new-in-the-mobile-apps.md).
...
* **Obtenir l’application** [Obtenez l’application Power BI pour Android](http://go.microsoft.com/fwlink/?LinkID=544867) à partir de Google Play.
  ...
  > [!NOTE]
  > Power BI peut s’exécuter sur différentes tablettes Android. Votre tablette doit exécuter le système d’exploitation Android 5.0 ou une version ultérieure. Pour le vérifier sur votre tablette, accédez à **Paramètres** > **À propos de l’appareil** > **Version d’Android**. 
  > 
  > 
* **Démarrer après l’ouverture de l’application** : sans vous inscrire ni même vous connecter, une fois que vous avez ouvert l’application, vous pouvez parcourir les pages de connexion pour avoir une vue d’ensemble rapide de ce que vous pouvez faire avec l’application Power BI sur votre tablette Android. Appuyez sur **Ignorer** pour afficher et explorer les exemples, et pour acquérir une expérience pratique de l’application. Vous pouvez [revenir aux exemples](mobile-android-tablet-app-get-started.md#try-the-power-bi-and-reporting-services-samples) à tout moment à partir de la page d’accueil des tableaux de bord.
...
Si vous ne vous êtes pas encore inscrit, accédez au [Power BI service (http://powerbi.com/)](http://powerbi.com/) pour le faire. Vous disposez alors d’un compte à l’aide duquel vous pouvez créer et stocker des tableaux de bord et des rapports, et regrouper vos données. Ensuite, connectez-vous à Power BI sur votre tablette Android pour consulter vos tableaux de bord où que vous soyez.
...
## <a name="get-started-with-the-power-bi-app-on-your-tablet"></a>Prise en main de l’application Power BI sur votre tablette
1. Sur votre tablette Android, à partir de l’écran d’accueil, ouvrez l’application Power BI pour Android.
   
   ![Icône de démarrage de Power BI](media/mobile-android-tablet-app-get-started/power-bi-logo-android.png)
2. Pour afficher vos tableaux de bord et vos rapports Power BI, appuyez sur **Power BI**.  
   ...
   Pour afficher vos rapports et indicateurs de performance clés Power BI Report Server et Reporting Services en local, appuyez sur **Report Server**.
   
   ![Connectez-vous à Power BI](media/mobile-android-tablet-app-get-started/power-bi-connect-to-login.png)
   
   Indiquez au serveur de rapports les informations de connexion pour [afficher les rapports et indicateurs de performance clés Power BI Report Server et Reporting Services](mobile-app-ssrs-kpis-mobile-on-premises-reports.md) dans l’application Power BI pour tablette Android.
...
1. Appuyez sur le bouton de navigation globale ![Bouton de navigation globale](media/mobile-android-tablet-app-get-started/power-bi-android-options-icon.png) en haut à gauche.
2. Appuyez sur **Paramètres** > **Découvrez nos exemples**, puis choisissez un rôle et explorez l’exemple de tableau de bord associé. 
   
   ![Exemples d’applications mobiles Power BI](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-samples.png)
...
2. Appuyez sur **Exemples Reporting Services**, puis ouvrez le dossier Retail Reports ou Sales Reports pour explorer les indicateurs de performance clés et les rapports mobiles.
   ...
   ![Exemples Reporting Services](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-ssrs-samples.png)

## <a name="search-for-a-dashboard-or-report"></a>Rechercher un rapport ou tableau de bord
* Appuyez sur la loupe dans l’angle supérieur droit ![Icône de recherche](media/mobile-android-tablet-app-get-started/power-bi-ipad-search-icon.png), puis tapez le terme à rechercher.
  
    ![Résultats de la recherche](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-search.png)
...
![Volet de navigation gauche de Power BI](media/mobile-android-tablet-app-get-started/power-bi-mobile-new-nav-no-numbers.png)
...
Sur la page Favoris dans les applications mobiles, vous pouvez afficher tous vos tableaux de bord Power BI favoris, ainsi que les indicateurs de performance clés et rapports sur le portail web Power BI Report Server ou Reporting Services. Quand vous mettez un tableau de bord en *favoris* dans l’application mobile Power BI, vous pouvez y accéder à partir de tous les appareils, y compris dans le service Power BI dans votre navigateur. 

* Appuyez sur **Favoris**.
  
   ![Favoris dans le volet de navigation gauche](media/mobile-android-tablet-app-get-started/power-bi-android-favorites-left-nav.png)
  
   Vos favoris Power BI et ceux des portails web Power BI Report Server et Reporting Services figurent tous sur cette page.
  
   ![Page Favoris](media/mobile-android-tablet-app-get-started/power-bi-android-tablet-favorites.png)
...
Découvrez ce que vous pouvez faire d’autre dans l’application pour tablette Android pour Power BI avec les tableaux de bord et les rapports dans Power BI, ainsi que les rapports et indicateurs de performance clés dans le portail web Power BI Report Server ou Reporting Services.
