---
title: "Optimisez vos données pour en avoir un aperçu rapide dans Power BI"
description: "Optimisez vos données pour les aperçus rapides Power BI. Si Power BI ne trouve pas d’informations dans vos données, voici quelques opérations que vous pouvez effectuer."
services: powerbi
documentationcenter: 
author: mihart
manager: kfile
