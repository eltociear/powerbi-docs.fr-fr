...
Les termes de jeu de données et source de données sont très utilisés dans Power BI. Ils sont souvent employés comme synonymes, mais en réalité, il s’agit de deux concepts complètement différents, bien que liés.
