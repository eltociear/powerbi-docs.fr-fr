...
* **Partage avec des utilisateurs externes** : le partage n’est autorisé qu’au sein d’un même locataire Power BI, et non avec des utilisateurs extérieurs au locataire Power BI.
