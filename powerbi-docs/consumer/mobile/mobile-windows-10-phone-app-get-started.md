...
### <a name="power-bi-samples"></a>Exemples Power BI
...
![Volet de navigation Power BI](./media/mobile-windows-10-phone-app-get-started/power-bi-win10-left-nav.png)
