...
2. Recherchez le tableau de bord à supprimer et sélectionnez l’icône Supprimer ![icône supprimer](./media/end-user-delete/power-bi-delete-icon.png).

    ![vidéo](./media/end-user-delete/power-bi-delete-dash.gif)
...
2. Recherchez le rapport à supprimer et sélectionnez l’icône Supprimer   ![icône supprimer](./media/end-user-delete/power-bi-delete-icon.png).   

    ![onglet Rapports d’un espace de travail](./media/end-user-delete/power-bi-delete-reportnew.png)
3. Confirmez la suppression.

   ![boîte de dialogue Supprimer le rapport](./media/end-user-delete/power-bi-delete-report.png)
...
2. Recherchez le classeur à supprimer et sélectionnez l’icône Supprimer ![icône supprimer](./media/end-user-delete/power-bi-delete-report2.png) .

    ![onglet Classeurs](./media/end-user-delete/power-bi-delete-workbooknew.png)
3. Confirmez la suppression.

   ![boîte de dialogue Supprimer le classeur](./media/end-user-delete/power-bi-delete-confirm.png)
...
2. Localisez le jeu de données à supprimer, puis sélectionnez les points de suspension (…).  
    ...
    ![onglet Jeux de données](./media/end-user-delete/power-bi-delete-datasetnew.png)
3. Dans la liste déroulante, sélectionnez **Supprimer**.

   ![menu des points de suspension](./media/end-user-delete/power-bi-delete-datasetnew2.png)
4. Confirmez la suppression.

   ![boîte de dialogue Supprimer le tableau de bord](./media/end-user-delete/power-bi-delete-dataset-confirm.png)
...
1. Dans le volet de navigation de gauche, sélectionnez **Espaces de travail**.
    ...
    ![Espaces de travail d’application](./media/end-user-delete/power-bi-delete-workspace.png)
2. Sélectionnez les points de suspension (…) à droite de l’espace de travail à supprimer, puis choisissez **Modifier l’espace de travail**.
   ...
   ![menu de points de suspension > Modifier l’espace de travail](./media/end-user-delete/power-bi-edit-workspace.png)
3. Dans la fenêtre **Modifier l’espace de travail**, sélectionnez **Supprimer l’espace de travail** > **Supprimer**.

    ![supprimer l’espace de travail](./media/end-user-delete/power-bi-delete-workspace2.png)
...
2. Dans l’angle supérieur droit, sélectionnez les points de suspension (…), puis choisissez **Quitter l’espace de travail** > **Quitter**.
      ...
      ![quitter l’espace de travail](./media/end-user-delete/power-bi-leave-workspace.png)
...
2. Pointez sur l’application à supprimer, puis sélectionnez l’icône Supprimer ![](./media/end-user-delete/power-bi-delete-report2.png).

   ![sélectionner Applications](./media/end-user-delete/power-bi-delete-app.png)

   Si vous supprimez accidentellement une application, vous disposez de plusieurs options pour la récupérer.  Vous pouvez demander au créateur de l’application de la renvoyer, rechercher l’e-mail d’origine contenant le lien vers l’application, consulter votre [centre de notifications](end-user-notification-center.md) pour voir si la notification relative à cette application y figure toujours, ou vérifier l’[AppSource](end-user-apps.md) de votre organisation.
...
* [Supprimer votre tableau de bord par défaut](end-user-featured.md#change-the-featured-dashboard)
* [Retirer un tableau de bord des favoris](end-user-favorite.md)
* [Supprimer une page de rapport](end-user-delete.md)
* [Supprimer une vignette de tableau de bord](../service-dashboard-edit-tile.md)
* [Supprimer une visualisation de rapport](end-user-delete.md)
