...
## <a name="show-data-in-reading-view"></a>Afficher des données en mode Lecture
...
## <a name="using-show-data-in-power-bi-service-reading-view"></a>Utiliser *Afficher les données* en mode Lecture dans le service Power BI
