...
description: Ce guide de démarrage rapide explique aux **consommateurs** comment utiliser le service Power BI.
services: powerbi
documentationcenter: ''
author: mihart
manager: kvivek
...
- Service Power BI (app.powerbi.com) <!-- app from AppSource -->
...
### <a name="view-an-app"></a>Afficher une application
...
1. Sélectionnez **Applications** ![Applications dans le volet de navigation de gauche](./media/end-user-apps/power-bi-apps-bar.png) > **Obtenir des applications**. 
     ...
     ![Icône Obtenir des applications](./media/end-user-reading-view/power-bi-get-app.png)
2. Dans AppSource, cherchez sous **Mon organisation** pour affiner les résultats et trouver l’application souhaitée.
   
     ![Dans AppSource sous Mon organisation](./media/end-user-reading-view/power-bi-appsource.png)
...
![tableau de bord](media/end-user-reading-view/power-bi-dashboard.png)
...
1. Dans la barre de menus supérieure, sélectionnez **S’abonner** ou l’icône en forme d’enveloppe ![icône S’abonner](./media/end-user-subscribe/power-bi-icon-envelope.png).
...
3. Utilisez le curseur jaune pour activer ou désactiver l’abonnement.  Facultativement, vous pouvez ajouter les détails du message. 
   ...
   ![fenêtre S’abonner](./media/end-user-subscribe/power-bi-emails.png)
...
### <a name="view-related-content"></a>Afficher le contenu associé
...
![contenu associé](./media/end-user-reading-view/power-bi-view-related-dashboard.png)
...
![Questions et réponses](./media/end-user-reading-view/power-bi-qna.png)
...
### <a name="open-and-view-a-report-and-report-pages"></a>Ouvrir et afficher un rapport et des pages de rapport
...
1. À partir d’un tableau de bord, sélectionnez une vignette. Dans cet exemple, nous avons sélectionné la vignette d’histogramme « Revenue ».
    ...
    ![tableau de bord avec la vignette sélectionnée](./media/end-user-reading-view/power-bi-dashboard2.png)
...
2.  Le rapport associé s’ouvre. Comme vous pouvez le voir, nous sommes sur la page « Revenue overview » (« Vue d’ensemble du chiffre d’affaires »). Il s’agit de la page de rapport qui contient l’histogramme que nous avons sélectionné à partir du tableau de bord.
    ...
    ![rapport ouvert en mode Lecture](./media/end-user-reading-view/power-bi-report-opens.png)
...
1. Pour l’ajuster, sélectionnez **Affichage** dans la barre de menus supérieure.
    ...
    ![menu Vue Rapport](media/end-user-reading-view/power-bi-fit.png)

2.  Choisissez l'une des options d’affichage. Dans cet exemple, nous avons choisi **Ajuster à la page**.

    ![Affichage Rapport Ajuster à la page](media/end-user-reading-view/power-bi-report-fit.png)    

### <a name="use-the-report-filters-pane"></a>Utiliser le volet Filtres d’un rapport
...
1. Sélectionnez l’icône **Filtres** située dans l’angle supérieur droit.
   ...
   ![sélectionner l’icône filtres](media/end-user-reading-view/filters.png)  
...
2. Sélectionnez un élément visuel pour l’activer. Tous les filtres appliqués à cet élément visuel (filtres au niveau de l’élément visuel), à l’ensemble de la page de rapport (filtres au niveau de la page) et à l’ensemble du rapport (filtres au niveau du rapport) apparaissent.
   ...
   ![types de filtres des rapports](media/end-user-reading-view/power-bi-reading-filters.png)

3. Pointez sur un filtre et développez-le en sélectionnant la flèche bas.
   
   ![développer le filtre](media/end-user-reading-view/power-bi-expan-filter.png)

4. Modifiez les filtres et constatez l’impact sur les visuels.  
   
     
     ![filtrage avancé](media/end-user-reading-view/power-bi-advanced-filter.png)

### <a name="see-how-all-the-visuals-on-a-page-are-interconnected"></a>Voir les interconnexions entre tous les éléments visuels d’une page
...
![passer la souris pour afficher les détails](media/end-user-reading-view/amarillachart.png)
...
###  <a name="open-the-selection-pane"></a>Ouvrez le volet **Sélection**.
...
1. Sélectionnez **Affichage > Volet Sélection** pour ouvrir le volet Sélection. Activez le **Volet Sélection**.
    ...
    ![Activer le volet Sélection du rapport](media/end-user-reading-view/power-bi-selection-pane2.png)

2. Le volet Sélection s’ouvre sur votre canevas de rapport. Sélectionnez un élément visuel dans la liste pour l’activer.

    ![Volet Sélection du rapport](media/end-user-reading-view/power-bi-selection-pane-new.png)
...
![mode Focus](media/end-user-reading-view/powerbi-focus-mode.png)

Pour afficher cette même visualisation sans les barres de menus, le volet des filtres et autres éléments superflus, sélectionnez l’icône **Plein écran** dans la barre de menus supérieure  ![icône plein écran](media/end-user-reading-view/power-bi-focus-icon.png)  .

![mode plein écran](media/end-user-reading-view/power-bi-full-screen.png)
