...
Pour afficher cette même visualisation sans les barres de menus, le volet des filtres et autres éléments superflus, sélectionnez l’icône **Plein écran** dans la barre de menus supérieure ![](media/end-user-reading-view/power-bi-focus-icon.png).
