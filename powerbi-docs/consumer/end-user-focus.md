...
|Visualisation des rapports | oui    | oui |
...
![tableau de bord en mode normal et en mode plein écran](media/end-user-focus/power-bi-full-screen-comparison.png)

Affichez le contenu de votre service Power BI (tableaux de bord, pages de rapport, mosaïques et visualisations) sans vous laisser distraire par les menus et barres de navigation.  Vous disposez en permanence d’une vue instantanée complète, et sans fioritures, de votre contenu. Elle est parfois appelée mode TV.   
...
![tableau de bord en mode normal et en mode plein écran](media/end-user-focus/power-bi-focus-compare.png)
...
![Menu pour les tableaux de bord](media/end-user-focus/power-bi-full-screen-menu-dashboard.png)    

Menu pour les pages de rapport    
![Menu pour les rapports](media/end-user-focus/power-bi-report-menu.png)    
  ...
  * ![Icône Ajuster à l’écran](media/end-user-focus/power-bi-fit-to-width.png)    
...
### <a name="focus-mode-in-dashboards"></a>Mode Focus dans les tableaux de bord
1. Ouvrez un tableau de bord dans le service Power BI.

2. Pointez sur la mosaïque du tableau de bord, sélectionnez les points de suspension (...) et choisissez **Ouvrir en mode Focus**.

    ![menu des points de suspension pour la mosaïque](media/end-user-focus/power-bi-dashboard-focus-mode.png).
...
1. Afficher un rapport dans le service Power BI.  Dans cet exemple, nous allons faire la démonstration de l’utilisation de l’échantillon d’analyse de la vente au détail.

1. Après l’ouverture du rapport, sélectionnez l’**onglet de ventes mensuelles du district**.

2. Déplacez le curseur sur le diagramme de zone en bas à gauche et sélectionnez l’icône **mode Focus** ![icône mode Focus](media/end-user-focus/pbi_popout.jpg).  
...
3. Si nécessaire, développez le volet Filtres pour interagir avec les filtres appliqués à ce visuel. Explorez les données à la recherche de nouvelles idées et de réponses à des questions. En tant que *consommateur*, vous ne pouvez pas ajouter de nouveaux filtres, modifier les champs utilisés dans les visualisations ou créer des visualisations.  Cependant, toutes les modifications que vous apportez aux filtres existants sont enregistrées lorsque vous quittez Power BI. Si vous ne souhaitez pas que Power BI se souvienne de vos modifications, sélectionnez **Rétablir les valeurs par défaut**. ![Bouton Rétablir les valeurs par défaut](media/end-user-focus/power-bi-resets.png)  

   ![mode focus avec l’écran Filtres](media/end-user-focus/power-bi-display-focus-filters3.png)
...
* Lorsque vous utilisez le mode Focus avec une visualisation dans un rapport, vous pouvez afficher tous les filtres et interagir avec eux : au niveau du visuel, de la page, de l’extraction et du rapport.    
* Lorsque vous utilisez le mode Focus avec une visualisation sur un tableau de bord, vous pouvez afficher uniquement le filtre au niveau du visuel, qui est le seul avec lequel vous pouvez interagir.
