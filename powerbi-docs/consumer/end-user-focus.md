...
![tableau de bord en mode normal et en mode plein écran](media/end-user-focus/power-bi-compare-dash.png)
...
## <a name="focus-mode-for-report-visuals"></a>Mode focus pour les visuels de rapport
...
2. Placez le curseur sur le treemap dans le coin supérieur gauche et sélectionnez l’icône **Mode focus** ![icône du mode focus](media/end-user-focus/pbi_popout.jpg).  
