...
* Serveur d’applications SAP BW ([Kerberos](service-gateway-sso-kerberos.md))
* Serveur de messages SAP BW ([Kerberos](service-gateway-sso-kerberos.md)) - Version préliminaire publique
* Oracle([Kerberos](service-gateway-sso-kerberos.md)) - Version préliminaire publique
